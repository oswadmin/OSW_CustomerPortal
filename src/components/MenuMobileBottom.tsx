		...
		<>
			...
			>
				...
				<div className="flex flex-row items-center gap-x-4 text-2xl">
					...
					<a
						href={siteConfig.OSW_Links.Facebook}
						aria-label="Facebook"
						target="_blank"
						rel="noopener noreferrer"
						className="rounded-full shadow-lg"
					>
						<Image src="/MediaIcon_Facebook.png" alt="Facebook" width={60} height={60} className="" />
					</a>
				</div>

				{/* INSTAGRAM BUTTON */}
				<div className="flex flex-row items-center gap-x-4 text-2xl">
					<span className="rounded-[12px] bg-white border-[1px] border-orange px-2 opacity-80">
						Instagram
					</span>
					...
					<a
						...
						className="rounded-full shadow-lg"
					>
						<Image src="/MediaIcon_Instagram.png" alt="Instagram" width={60} height={60} className="" />
					</a>
				</div>
