        ...
        {cardURL === "" ? 
          <>
            <div className='flex flex-1 justify-center '>
              <div className='flex w-[250px] h-[400PX] rounded-xl shadow-lg border-[1px] border-orange relative overflow-hidden justify-center'>
                {children}
              </div>
            </div>
            <div className="text-center flex-1 mt-2 mb-2 justify-center items-center text-3xl font-bold card-service-text">
              {cardTitle}
            </div>
          </>
        : (
