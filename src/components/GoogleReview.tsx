...
export default function GoogleReviews({ placeId }: GoogleReviewsProps) {
  ...
  return (
    <>
    <div className='flex desktop:hidden flex-1 shadow-lg border-y-gray_light mx-16 px-4 py-2 rounded-2xl space-x-4'>
    ...
    <div className='hidden desktop:flex flex-1 shadow-lg border-y-gray_light mx-16 px-4 py-2 rounded-2xl space-x-4'>
      ...
      <div className="flex flex-1 justify-end">
        <ButtonStandard strURL="https://search.google.com/local/reviews?placeid=ChIJQ7ge5FCdNKMRdhLJTP6maks" className="bg-gradient-to-b from-orange_light to-orange hover:bg-orange w-full desktop:w-48 h-[50px] text-xl">
          Write a review
        </ButtonStandard>
      </div>
    </div>
