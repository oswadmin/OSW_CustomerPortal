				...
				details: [
					{
						...
						detailDescription:
							"Accumulating grime seems to be a superpower of hard surfaces.  While there is no miracle to keep them clean forever, with our refined C3PO process you'll get the longest lasting results possible.",
					...
					},
					{
						...
						detailDescription:
							"Often, it's more than just grime that makes your surfaces look bad.  We can treat oil, paint, rust, tire and hard water marks, sometimes removing them entirely.",
					...
					},
					{
						...
						detailDescription:
							"The cleaning is complete, but the job's not truly done. Sealer guards against future stains and chemical damage, while fresh sand revitalizes those joints. Investing in these services will pay off for years to come.",
				...
				details: [
					{
						...
						detailDescription:
							"Regardless of what your home or business is surrounded with, our gentle and effective cleaning methods will leave your property sparkling clean without causing any damage.",
					...
					},
					{
						...
						detailDescription:
							"And hey, while we're making things shine, don't forget to check out our Waste Bin service! You get TWO FREE residential bin cleanings with any whole-house siding wash.  Because who wants a sparkling house with stinky bins?",
					...
					},
					{
						...
						detailDescription:
							"Our Citrus Spider Shield isn't just a scent, it's an eviction notice! This specialized, long-lasting treatment creates a barrier spiders despise. Think of it as giving spiders a 'taste' of orange they won't forget, sending them packing!",
				...
				details: [
					{
						...
						detailDescription:
							"We promise to never use high pressure on any deck material.  You can have peace of mind that your deck will not be damaged by our gentle soft deck wash service.",
					...
					},
					{
						...
						detailDescription:
							"People are amazed at the magical transformations we can bring to your outdoor spaces.  Whether your looking to brighten, seal, or restain, your deck, we'll make it look as though it were touched by an enchantment.",
						detailImageURL: siteConfig.OSW_IMG.DECK1,
						detailImageAlt: "",
						detailImageClass: "",
					},
				...
				details: [
					{
						...
						detailDescription:
							"We thoroughly wash all fence types, carefully removing dirt and grime with our soft washing techniques. Your fence will shine again!",
					...
					},
					{
						...
						detailDescription:
							"We expertly seal, stain, and repair broken fences, revitalizing your property's perimeter.",
				...
				details: [
					{
						...
						detailDescription:
							"We use a customized soft wash technique, perfectly tailored to your roofing material, to banish algae, moss, and grime without causing damage. Our skilled technicians will leave your roof sparkling clean!",
				...
				details: [
					{
						...
						detailDescription:
							'Unsightly "tiger stripes" on your gutters are caused by a stubborn build-up of dirt, pollen, and grime. Our Gutter brightening service will tame those stripes, gently removing years of accumulated stains revealing the clean, bright gutters beneath.',
					...
					},
					{
						...
						detailDescription:
							"To keep your gutters looking their best, you need proper flow! We can also remove all debris, ensuring those stripes don't return for as long as possible.",
					...
					},
					{
						...
						detailDescription:
							"Orange Soft Wash can also flush out downspouts and clear drains, preventing backups and keeping those tiger stripes at bay.  Don't let clogged downspouts ruin your freshly brightened gutters!",
				...
				details: [
					{
						...
						detailDescription:
							"Our experienced teams can scale any service to meet your property needs.  We use industry-standard equipment and proven techniques, to deliver maximum results with minimal disruption to your operations.",
...

					{
						...
						detailDescription:
							"Our teams use a combination of pressure and soft washing to tackle exceptionally tough commercial grease and organic buildup to leaving your dumpster(s) & pad(s) thoroughly sanitized and refreshed.",
